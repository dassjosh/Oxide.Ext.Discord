...
public enum DiscordWebsocketCloseCode
{
    ...
    /// <summary>
    /// The session would have handled too many guilds - you are required to shard your connection to connect.
    /// </summary>
    ...
    /// <summary>
    /// You sent a disallowed intent for a Gateway Intent. You may have tried to specify an intent that you have not enabled or are not allowlisted for.
    /// </summary>
