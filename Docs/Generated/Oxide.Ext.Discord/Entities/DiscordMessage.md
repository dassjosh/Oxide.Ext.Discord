...
| [Application](#application-property) { get; set; } | Sent with Rich Presence-related chat embeds [`DiscordApplication`](./DiscordApplication.md) |
...
| [Embeds](#embeds-property) { get; set; } | Any embedded content [`DiscordEmbed`](./DiscordEmbed.md) |
...
| [Poll](#poll-property) { get; set; } | Poll object |
...
* [DiscordMessage.cs](../../../../Oxide.Ext.Discord/Entities/DiscordMessage.cs)
   
   
...
Member properties for this message's author [`GuildMember`](./GuildMember.md)
...
Users specifically mentioned in the message [`DiscordUser`](./DiscordUser.md)
...
Channels specifically mentioned in this message [`ChannelMention`](./ChannelMention.md)
...
Any embedded content [`DiscordEmbed`](./DiscordEmbed.md)
...
Sent with Rich Presence-related chat embeds [`DiscordApplication`](./DiscordApplication.md)
...
Data showing the source of a crosspost, channel follow add, pin, or reply message [`MessageReference`](./MessageReference.md)
